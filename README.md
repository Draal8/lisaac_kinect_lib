This project is a library written in lisaac programming language (http://lisaac.org/) with the purpose to allow simple use of the kinect v2 device by programmers.
